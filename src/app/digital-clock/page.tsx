...
const FlipClockWidget = () => {
    ...
    return (
        <div className="min-h-screen bg-[#004900] p-4 md:p-8"
            style={{ backgroundImage: "url('images/grid-bg.svg')" }}>
            <div className="">
                {/* Header */}
                <div className="text-center mb-8">
                    <h1 className="text-4xl md:text-7xl font-heading text-white mb-2">Digital Clock Widget</h1>
                    <p className="text-white">Customize your aesthetic clock for Notion</p>
                </div>

                <div className="md:grid md:grid-cols-2 gap-8 bg-amber-300">
                    {/* <NotionClone /> */}
                    {/* Clock Preview */}
                    ...
                    <div className="order-2">
                        <div className="">
                            <div
                                className="rounded-3xl p-8 shadow-2xl transition-all duration-300 z-10"
                            ...
                            {/* Embed Code */}
                            <div className="mt-6 btext-white bg-[#004900] rounded-2xl shadow-inner-xl p-6 border border-gray-300/40 text-white">
                                <div className="flex items-center justify-between mb-3">
                                    <h3 className="font-heading text-3xl">Embed in Notion</h3>
                                    <button
                                        onClick={copyEmbedCode}
                                        className="flex items-center gap-2 px-4 py-2 bg-black hover:bg-gray-200 rounded-lg transition-colors text-sm font-medium"
                                    >
                                        {copied ? (
                                            <>
                                ...
                                <div className="bg-white/20 rounded-lg p-3 text-sm text-white font-mono break-all">
                                    {generateEmbedCode()}
                                </div>
                                <p className="text-xs text-white mt-2">
                                    In Notion: Type <code className="bg-black px-1 rounded">/embed</code> → Paste this URL
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Customization Panel */}
                    <div className="order-1 max-w-md">
                        <div className="text-white bg-[#004900] rounded-2xl shadow-inner-xl p-6 border border-gray-300/40 w-screen">
                            <div className="flex items-center gap-3 mb-6">
                                <Palette className="w-6 h-6 " />
                                <h2 className="text-4xl font-heading">Customize</h2>
                            </div>
                                    ...
                                    {themes.map((t) => (
                                        ...
                                        >
                                            <div className="flex flex-col md:flex-row items-center justify-between">
                                                <div className="text-xl md:text-3xl font-heading capitalize mb-2"
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-xs mb-2">Background</label>
                                    <div className="flex gap-2">
                                        ...
                                        <input
                                            ...
                                            value={theme.background}
                                            onChange={(e) => setTheme({ ...theme, background: e.target.value, name: 'custom' })}
                                            className="w-28 px-3 border-2 border-gray-300/40 rounded-lg text-sm font-mono"
                                        />
                                    </div>
                                </div>

                                <div>
                                    <label className="block text-xs mb-2">Card Background</label>
                                    <div className="flex gap-2">
                                        <input
                                            type="color"
                                            value={theme.cardBg}
                                ...
                                <div>
                                    <label className="block text-xs te mb-2">Card Border</label>
                                    <div className="flex gap-2">
                                        <input
                                            type="color"
                                ...
                                <div>
                                    <label className="block text-xs mb-2">Text Color</label>
                                    <div className="flex gap-2">
                                        <input
                                            type="color"
                            ...
                            <div className="mt-6 shadow-xl p-10"
                                style={{ backgroundImage: "url('/images/sticky-note.png')" }}>
                                <h3 className=" text-black mb-2 text-4xl font-handwritten">💡 Pro Tips</h3>
                                <ul className="text-2xl text-black font-handwritten space-y-1">
